...
修改说明：
1. 原始脚本路径：scripts/parachrsnp-report_2.py
2. 本版本在统一 HTML 报告中新增 CNVnator CNV 结果统计和 CNV 图形展示。
...
AUTHOR = "Junpeng Ma 1527552938@qq.com"
SCRIPT_NAME = "parachrsnp-report_3.py"
SCRIPT_FUNCTION = "Generate ParaChrSNP HTML report with embedded workflow and CNV figures."
